OpenJNLP - an Open-Source Java Network Launching Manager
...
OpenJNLP allows a user to retrieve JNLP apps via URL. Retrieved JNLP apps are added to a list of known apps, which a user can choose to launch at any time. Any retrieved apps are remembered on the local system for quick availability every time OpenJNLP is run.
...
OpenJNLP is open source and is released under the Mozilla Public License 1.1 (MPL 1.1). See License.txt for the specific licensing terms.
